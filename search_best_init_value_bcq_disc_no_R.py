...
base_dir = "./d3rlpy_logs/fqe_./d3rlpy_logs/bcq_training_discrete_no_R./configs/bcq_disc_generated"
        ...
        if os.path.isdir(subsubdir_path):
            ...
            if os.path.exists(init_value_path) and os.path.exists(loss_path):
                try:
                    ...
                    if not filtered_df.empty and (merged_df["Init Value"] < -0.1).all():
...
if results:
    ...
    top_10.to_csv("bcq_training_discrete_no_R_top_10_results.csv", index=False)
