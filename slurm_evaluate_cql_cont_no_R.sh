...
model_base_dir="d3rlpy_logs/cql_training_continuous_no_R./configs/cql_cont_generated"
...
python evaluate.py --is_continuous --model_dir "$model_dir" --data_path "./Continuous Data/val_data_continuous_no_R_for_Survival.csv" --algorithm "cql"
