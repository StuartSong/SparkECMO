...
sofa_scores['long_term_reward'] = sofa_scores['long_term_reward'].replace(10, 0)
...
train_data.to_csv("train_data_continuous_no_R_for_Survival.csv",index=False)
test_data.to_csv("test_data_continuous_no_R_for_Survival.csv",index=False)
