...
model_base_dir="d3rlpy_logs/cql_training_continuous_no_R./configs/generated"
...
python evaluate.py --model_dir "$model_dir" --data_path "./Continuous Data/test_data_continuous_no_R_for_Survival.csv" --algorithm "cql"
