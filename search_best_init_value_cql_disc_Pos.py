...
base_dir = "./d3rlpy_logs/fqe_./d3rlpy_logs/cql_training_discrete_Pos./configs/cql_disc_generated"
        ...
        if os.path.isdir(subsubdir_path):
            ...
            if os.path.exists(init_value_path) and os.path.exists(loss_path):
                try:
                    ...
                    if not filtered_df.empty and (merged_df["Init Value"] < 0.5).all():
...
if results:
    ...
    top_10.to_csv("cql_training_discrete_Pos_top_10_results.csv", index=False)
