...
python train.py --config "$CONFIG_FILE" --algorithm bcq --data_type continuous_Pos --data_path './Continuous Data/train_data_continuous_Pos_for_Survival.csv' --is_continuous
