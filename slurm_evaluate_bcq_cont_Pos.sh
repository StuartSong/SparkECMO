...
model_base_dir="d3rlpy_logs/bcq_training_continuous_Pos./configs/bcq_cont_generated"
...
python evaluate.py --is_continuous --model_dir "$model_dir" --data_path "./Continuous Data/val_data_continuous_Pos_for_Survival.csv" --algorithm "bcq"
