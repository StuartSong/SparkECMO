...
base_dir = "./d3rlpy_logs/fqe_./d3rlpy_logs/bcq_training_continuous_no_R./configs/bcq_cont_generated"
        ...
        if os.path.isdir(subsubdir_path):
            ...
            if os.path.exists(init_value_path) and os.path.exists(loss_path):
                try:
                    ...
                    filtered_df = merged_df[merged_df["Loss"] < 0.22].copy()
...
if results:
    ...
    top_10.to_csv("bcq_training_continuous_no_R_top_10_results.csv", index=False)
