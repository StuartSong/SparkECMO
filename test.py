...
def main(args):
    ...
    if args.algorithm == 'cql' and args.is_continuous:
        ...
        model_steps = range(10000, 30001, 10000) 
        ...
        for step in model_steps:
            ...
            fqe = d3rlpy.ope.DiscreteFQE(algo=cql, config=d3rlpy.ope.FQEConfig())
            scores = fqe.fit(
                dataset,
                n_steps=2000,
                n_steps_per_epoch=100,
        ...
        for step in model_steps:
            ...
            fqe = d3rlpy.ope.DiscreteFQE(algo=bcq, config=d3rlpy.ope.FQEConfig())
            scores = fqe.fit(
                dataset,
                n_steps=2000,
                n_steps_per_epoch=100,
