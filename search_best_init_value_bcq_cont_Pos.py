...
base_dir = "./d3rlpy_logs/fqe_./d3rlpy_logs/bcq_training_continuous_Pos./configs/bcq_cont_generated"
...
if results:
    ...
    top_10.to_csv("bcq_training_continuous_Pos_top_10_results.csv", index=False)
