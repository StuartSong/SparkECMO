...
python train.py --config "$CONFIG_FILE" --algorithm bcq --data_type continuous_no_R --data_path './Continuous Data/train_data_continuous_no_R_for_Survival.csv' --is_continuous