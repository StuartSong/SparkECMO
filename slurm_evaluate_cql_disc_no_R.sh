...
model_base_dir="d3rlpy_logs/cql_training_discrete_no_R./configs/cql_disc_generated"
...
python evaluate.py --model_dir "$model_dir" --data_path "./Discrete Data/val_data_discrete_no_R_for_Survival.csv" --algorithm "cql"
